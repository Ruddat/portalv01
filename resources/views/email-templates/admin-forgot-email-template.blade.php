                                    ...
                                    <tr>
                                        <td align="center" style="font-size:0px;padding:10px 25px;padding-bottom:40px;word-break:break-word;">
                                            ...
                                            <div style="font-family:'Helvetica Neue',Arial,sans-serif;font-size:38px;font-weight:bold;line-height:1;text-align:center;color:#555;">
                                                {{ app(\App\Services\TranslationService::class)->trans('Oops!', app()->getLocale()) }}
                                            </div>
                                    ...
                                    <tr>
                                        <td align="center" style="font-size:0px;padding:10px 25px;padding-bottom:40px;word-break:break-word;">
                                            ...
                                            <div style="font-family:'Helvetica Neue',Arial,sans-serif;font-size:18px;line-height:1;text-align:center;color:#555;">
                                              {{ app(\App\Services\TranslationService::class)->trans('It seems that you have forgotten your password.', app()->getLocale()) }}
                                            </div>
                                            ...
                                            <table align="center" border="0" cellpadding="0" cellspacing="0" role="presentation" style="border-collapse:separate;line-height:100%;">
                                                <tr>
                                                    ...
                                                    <td align="center" bgcolor="#2F67F6" role="presentation" style="border:none;border-radius:3px;color:#ffffff;cursor:auto;padding:15px 25px;" valign="middle">
                                                        <a href="{{ $actionLink }}" target="_blank" class="btn btn-primary">
                                                        ...
                                                        <a href="{{ $actionLink }}" target="_blank" class="btn btn-primary">Reset Password</a>
                                                    </td>
                                                </tr>
                                            </table>
