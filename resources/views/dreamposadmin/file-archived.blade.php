                ...
                <div class="col-lg-3 col-md-12 sidebars-right theiaStickySidebar section-bulk-widget">
                    <aside class="card file-manager-sidebar mb-0">
                        ...
                        <ul class="mb-5">
                            ...
                            <li><a href="{{ url('file-archived') }}" class="active"><span class="me-2 btn-icon"><i
                                            data-feather="target" class="feather-16"></i></span>Archived</a></li>
                                                        ...
                                                        <span class="avatar">
                                                            <a href="javascript:void(0);" data-bs-toggle="tooltip"
                                                                ...
                                                                data-bs-original-title="Member 1"><img
                                                                    src="{{ URL::asset('/build/img/avatar/avatar-2.jpg') }}" alt="Avatar"></a>
                                                        </span>
                                                        <span class="avatar">
                                                            <a href="javascript:void(0);" data-bs-toggle="tooltip"
                                                                data-bs-placement="right" aria-label="Member 2"
                                                                data-bs-original-title="Member 2"><img
                                                                    src="{{ URL::asset('/build/img/avatar/avatar-1.jpg') }}" alt="Avatar"></a>
                                                        </span>
                                                        <span class="count">
                                                    ...
                                                    <div class="group-avatar">
                                                        <span class="avatar">
                                                            <a href="javascript:void(0);" data-bs-toggle="tooltip"
                                                                data-bs-placement="right" aria-label="Member 1"
                                                                data-bs-original-title="Member 1"><img
                                                                    src="{{ URL::asset('/build/img/avatar/avatar-6.jpg') }}" alt="Avatar"></a>
                                                        </span>
                                                        <span class="avatar">
                                                            <a href="javascript:void(0);" data-bs-toggle="tooltip"
                                                                data-bs-placement="right" aria-label="Member 2"
                                                                data-bs-original-title="Member 2"><img
                                                                    src="{{ URL::asset('/build/img/avatar/avatar-14.jpg') }}" alt="Avatar"></a>
                                                        </span>
                                                        <span class="avatar">
                                                            <a href="javascript:void(0);" data-bs-toggle="tooltip"
                                                                data-bs-placement="right" aria-label="Member 3"
                                                                data-bs-original-title="Member 3"><img
                                                                    src="{{ URL::asset('/build/img/avatar/avatar-15.jpg') }}" alt="Avatar"></a>
                                                        </span>
                                                        <span class="avatar">
                                                            <a href="javascript:void(0);" data-bs-toggle="tooltip"
                                                                data-bs-placement="right" aria-label="Member 4"
                                                                data-bs-original-title="Member 4"><img
                                                                    src="{{ URL::asset('/build/img/avatar/avatar-16.jpg') }}" alt="Avatar"></a>
                                                        </span>
                                                        <span class="avatar">
                                                            <a href="javascript:void(0);" data-bs-toggle="tooltip"
                                                                data-bs-placement="right" aria-label="Member 5"
                                                                data-bs-original-title="Member 5"><img
                                                                    src="{{ URL::asset('/build/img/avatar/avatar-17.jpg') }}" alt="Avatar"></a>
                                                        </span>
                                                        <span class="count">
                                                    ...
                                                    <div class="group-avatar">
                                                        ...
                                                        <span class="avatar">
                                                            <a href="javascript:void(0);" data-bs-toggle="tooltip"
                                                                data-bs-placement="right" aria-label="Member 3"
                                                                data-bs-original-title="Member 3"><img
                                                                    src="{{ URL::asset('/build/img/avatar/avatar-3.jpg') }}" alt="Avatar"></a>
                                                        </span>
                                                        <span class="avatar">
                                                            <a href="javascript:void(0);" data-bs-toggle="tooltip"
                                                                data-bs-placement="right" aria-label="Member 4"
                                                                data-bs-original-title="Member 4"><img
                                                                    src="{{ URL::asset('/build/img/avatar/avatar-4.jpg') }}" alt="Avatar"></a>
                                                        </span>
                                                        <span class="count">
                                                            <a href="javascript:void(0);">1 Members</a>
                                                        </span>
                                                    ...
                                                    <div class="group-avatar">
                                                        <span class="avatar">
                                                            <a href="javascript:void(0);" data-bs-toggle="tooltip"
                                                                data-bs-placement="right" aria-label="Member 1"
                                                                data-bs-original-title="Member 1"><img
                                                                    src="{{ URL::asset('/build/img/avatar/avatar-18.jpg') }}" alt="Avatar"></a>
                                                        </span>
                                                        <span class="avatar">
                                                            <a href="javascript:void(0);" data-bs-toggle="tooltip"
                                                                data-bs-placement="right" aria-label="Member 2"
                                                                data-bs-original-title="Member 2"><img
                                                                    src="{{ URL::asset('/build/img/avatar/avatar-5.jpg') }}" alt="Avatar"></a>
                                                        </span>
                                                        <span class="count">
                            ...
                            <table class="table datanew">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="javascript:void(0);" class="product-img d-flex align-items-center">
                                                <img src="{{ URL::asset('/build/img/avatar/avatar-6.jpg') }}" alt="Product"
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="javascript:void(0);" class="product-img d-flex align-items-center">
                                                <img src="{{ URL::asset('/build/img/avatar/avatar-5.jpg') }}" alt="Product"
                                                    class="me-2 rounded-circle">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="javascript:void(0);" class="product-img d-flex align-items-center">
                                                <img src="{{ URL::asset('/build/img/avatar/avatar-10.jpg') }}" alt="Product"
                                                    class="me-2 rounded-circle">
                                                <span>Me</span>
                                            </a>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="javascript:void(0);" class="product-img d-flex align-items-center">
                                                <img src="{{ URL::asset('/build/img/avatar/avatar-2.jpg') }}" alt="Product"
                                                    class="me-2 rounded-circle">
                                                <span>Daniel</span>
                                            </a>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="javascript:void(0);" class="product-img d-flex align-items-center">
                                                <img src="{{ URL::asset('/build/img/avatar/avatar-7.jpg') }}" alt="Product"
                                                    class="me-2 rounded-circle">
                                                <span>Henriques</span>
                                            </a>
                                        </td>
