            ...
            <div class="row">
                <div class="col-lg-3 col-md-12 sidebars-right theiaStickySidebar section-bulk-widget">
                    <aside class="card file-manager-sidebar mb-0">
                        ...
                        <ul class="mb-5">
                            <li><a href="{{ url('file-manager') }}" class="active"><span class="me-2 btn-icon"><i
                                            data-feather="file-text" class="feather-16"></i></span>My Files</a></li>
                ...
                <div class="col-lg-9 budget-role-notes">
                                ...
                                <div class="detail">
                                    <a href="javascript:void(0);"
                                        ...
                                        <span class="d-flex align-items-center justify-content-center"><img
                                                src="{{ URL::asset('/build/img/icons/folder.svg') }}"
                                                alt="Folder"></span>
                                    </a>
                            ...
                            <div class="col-sm-6 col-md-3">
                                <div class="detail">
                                    <a href="javascript:void(0);"
                                        ...
                                        <span class="d-flex align-items-center justify-content-center"><img
                                                src="{{ URL::asset('/build/img/icons/pdf-02.svg') }}"
                                                alt="Folder"></span>
                                    </a>
                                    <div class="d-flex align-items-center justify-content-between info">
                            ...
                            <div class="col-sm-6 col-md-3">
                                <div class="detail">
                                    <a href="javascript:void(0);"
                                        ...
                                        <span class="d-flex align-items-center justify-content-center"><img
                                                src="{{ URL::asset('/build/img/icons/image.svg') }}"
                                                alt="Folder"></span>
                                    </a>
                                    <div class="d-flex align-items-center justify-content-between info">
                            ...
                            <div class="col-sm-6 col-md-3">
                                <div class="detail">
                                    <a href="javascript:void(0);"
                                        class="d-flex align-items-center justify-content-center bg-light-red bg p-4">
                                        <span class="d-flex align-items-center justify-content-center"><img
                                                src="{{ URL::asset('/build/img/icons/video.svg') }}"
                                                alt="Folder"></span>
                                    </a>
                                    <div class="d-flex align-items-center justify-content-between info">
                            ...
                            <div class="col-sm-6 col-md-3">
                                <div class="detail">
                                    <a href="javascript:void(0);"
                                        class="d-flex align-items-center justify-content-center bg-light-orange bg p-4">
                                        <span class="d-flex align-items-center justify-content-center"><img
                                                src="{{ URL::asset('/build/img/icons/audio.svg') }}"
                                                alt="Folder"></span>
                                    </a>
                                    <div class="d-flex align-items-center justify-content-between info">
                    ...
                    <div class="accordion" id="accordionPanelsStayOpenExample">
                                            ...
                                            <div class="d-flex align-items-center justify-content-between head">
                                                ...
                                                <div class="dropdown">
                                                    ...
                                                    <ul class="dropdown-menu">
                                                        ...
                                                        <li><a href="javascript:void(0);" class="dropdown-item">Share</a>
                                                        </li>
                                                        <li><a href="javascript:void(0);" class="dropdown-item">Copy</a>
                                                        </li>
                                                        <li><a href="javascript:void(0);" class="dropdown-item">Move</a>
                                                        </li>
                                                        <li><a href="javascript:void(0);"
                                                                class="dropdown-item">Download</a></li>
                                                        <li><a href="javascript:void(0);" class="dropdown-item">Rename</a>
                                                        </li>
                                                        <li><a href="javascript:void(0);"
                                                                class="dropdown-item">Archeived</a></li>
                                                        <li><a href="javascript:void(0);" class="dropdown-item">Delete</a>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </div>
                                                ...
                                                <div class="group-avatar">
                                                    ...
                                                    <span class="avatar">
                                                        <a href="javascript:void(0);" data-bs-toggle="tooltip"
                                                            data-bs-placement="right" aria-label="Member 3"
                                                            data-bs-original-title="Member 3"><img
                                                                src="{{ URL::asset('/build/img/avatar/avatar-3.jpg') }}"
                                                                alt="Avatar"></a>
                                                    </span>
                                                    <span class="avatar">
                                                        <a href="javascript:void(0);" data-bs-toggle="tooltip"
                                                            data-bs-placement="right" aria-label="Member 4"
                                                            data-bs-original-title="Member 4"><img
                                                                src="{{ URL::asset('/build/img/avatar/avatar-4.jpg') }}"
                                                                alt="Avatar"></a>
                                                    </span>
                                                    <span class="count">
                                                        <a href="javascript:void(0);">1 Members</a>
                                        ...
                                        <div class="folders p-3">
                                            <div class="d-flex align-items-center justify-content-between head">
                                                <div class="d-flex align-items-center">
                                                    <img src="{{ URL::asset('/build/img/icons/pdf-02.svg') }}"
                                                        alt="File" class="me-2">
                                                    <h6 class="popup-toggle"><a href="javascript:void(0);">Haird.pdf</a>
                                                    </h6>
                                                </div>
                                                <div class="d-flex align-items-center">
                                                    <a href="javascript:void(0);" class=""><i
                        ...
                        <div class="accordion-item mb-4">
                            <h4 class="accordion-header d-flex align-items-center justify-content-between"
                                id="panelsStayOpen-headingThree">Videos
                                <a href="javascript:void(0);" class="accordion-button w-auto" data-bs-toggle="collapse"
                                    data-bs-target="#panelsStayOpen-collapseThree" aria-expanded="false"
                                    aria-controls="panelsStayOpen-collapseThree"></a>
                            </h4>
                            <div id="panelsStayOpen-collapseThree" class="accordion-collapse collapse show"
                                ...
                                <div class="accordion-body">
                                    <div class="owl-carousel video-section">
                                        ...
                                        <div class="item">
                                            <div>
                                                <video width="100" height="100" class="js-player" crossorigin
                                                    playsinline poster="build/img/file-manager/video1.jpg">
                                                    <source
                                            ...
                                            <div class="info">
                                                <div class="d-flex align-items-center justify-content-between">
                                                    <h6 class="popup-toggle"><a href="javascript:void(0);">Demo_dw</a>
                                                    </h6>
                                                    <div class="d-flex align-items-center">
                                                        <a href="javascript:void(0);" class="d-flex align-items-center"><i
                                                                data-feather="star" class="feather-16 me-2"></i></a>
                                                        <div class="dropdown">
                                                            <a href="javascript:void(0);" data-bs-toggle="dropdown"
                                                                aria-expanded="false" class="dropset">
                                                                <i class="fa fa-ellipsis-v"></i>
                                        ...
                                        <div class="item">
                                            <div>
                                                <video class="js-player" crossorigin playsinline
                                                    poster="build/img/file-manager/video2.jpg">
                                                    <source
                                                        src="https://cdn.plyr.io/static/demo/View_From_A_Blue_Moon_Trailer-720p.mp4"
                                                        type="video/mp4">
                                                </video>
                                            ...
                                            <div class="info">
                                                <div class="d-flex align-items-center justify-content-between">
                                                    <h6 class="popup-toggle"><a
                                                            href="javascript:void(0);">Android_bike.mp4</a></h6>
                                                    <div class="d-flex align-items-center">
                                                        <a href="javascript:void(0);" class="d-flex align-items-center"><i
                                                                data-feather="star" class="feather-16 me-2"></i></a>
                                                        <div class="dropdown">
                                        ...
                                        <div class="item">
                                            <div>
                                                <video class="js-player" crossorigin playsinline
                                                    poster="build/img/file-manager/video3.jpg">
                                                    <source
                                                        src="https://cdn.plyr.io/static/demo/View_From_A_Blue_Moon_Trailer-720p.mp4"
                                                        type="video/mp4">
                                                </video>
                                            ...
                                            <div class="info">
                                                <div class="d-flex align-items-center justify-content-between">
                                                    <h6 class="popup-toggle"><a
                                                            href="javascript:void(0);">Demoparticles.mp4</a></h6>
                                                    <div class="d-flex align-items-center">
                                                        <a href="javascript:void(0);" class="d-flex align-items-center"><i
                                                                data-feather="star" class="feather-16 me-2"></i></a>
                                                        <div class="dropdown">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="productimgname">
                                            <a href="{{ url('product-list') }}"
                                                class="product-img d-flex align-items-center">
                                                <img src="{{ URL::asset('/build/img/icons/video.svg') }}"
                                                    alt="Product" class="me-2">
                                    ...
                                    <tr>
                                        ...
                                        <td class="productimgname">
                                            <a href="{{ url('product-list') }}"
                                                class="product-img d-flex align-items-center">
                                                <img src="{{ URL::asset('/build/img/icons/audio.svg') }}"
                                                    alt="Product" class="me-2">
                                                <span>voice.mp3</span>
                                            </a>
                                        </td>
