        ...
        <div class="content">
            <div class="welcome d-lg-flex align-items-center justify-content-between">
                ...
                <div class="d-flex align-items-center welcome-text">
                    <h3 class="d-flex align-items-center"><img src="{{ URL::asset('/build/img/icons/hi.svg') }}" alt="img">&nbsp;Hi {{ Auth::guard('broker')->user()->first_name }},</h3>&nbsp;<h6>here's what's happening with your store today.</h6>
                </div>
            @else
                <div class="d-flex align-items-center welcome-text">
                    <h3 class="d-flex align-items-center"><img src="{{ URL::asset('/build/img/icons/hi.svg') }}" alt="img">&nbsp;Hi Guest,</h3>&nbsp;<h6>please log in to see your store details.</h6>
                </div>
            @endauth
