                                        ...
                                        <ul class="w-100">
                                            ...
                                            <li>
                                                <div class="integration-btn">
                                                    <a href="" data-bs-toggle="modal" data-bs-target="#php-mail"><i
                                                            data-feather="tool" class="me-2"></i>Connect</a>
                                                </div>
                                                <div
                                ...
                                <div class="col-xxl-4 col-xl-6 col-lg-12 col-md-6 d-flex">
                                    <div class="connected-app-card email-setting d-flex w-100">
                                        <ul class="w-100">
                                            ...
                                            <li>
                                                <div class="integration-btn">
                                                    <a href="" data-bs-toggle="modal" data-bs-target="#smtp-mail"><i
                                                            data-feather="tool" class="me-2"></i>Connect</a>
                                                </div>
                                                <div
                                                    class="status-toggle modal-status d-flex justify-content-between align-items-center ms-2">
                                    ...
                                    <div class="connected-app-card email-setting d-flex w-100">
                                        <ul class="w-100">
                                            <li class="flex-column align-items-start">
                                                ...
                                                <p>Cloud-based email marketing tool that assists marketers and developers .
                                                </p>
                                            </li>
                                            <li>
                                                <div class="integration-btn">
                                                    <a href="" data-bs-toggle="modal" data-bs-target="#test-mail"><i
                                                            data-feather="tool" class="me-2"></i>View Integration</a>
                                                </div>
                                                <div
                                                    class="status-toggle modal-status d-flex justify-content-between align-items-center ms-2">
