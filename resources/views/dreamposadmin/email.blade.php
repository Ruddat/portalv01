        ...
        <div class="content">
            ...
            <div class="row">
                <div class="col-lg-3 col-md-12">
                    ...
                    <ul class="inbox-menu">
                        <li class="active">
                            <a href="javascript:void(0);"><i class="fas fa-download"></i> Inbox <span
                        ...
                        <li>
                            <a href="javascript:void(0);"><i class="far fa-file-alt"></i> Drafts <span
                                        ...
                                        <tbody>
                                            <tr class="unread clickable-row">
                                                ...
                                                <td><span class="mail-important"><i
                                                            class="fas fa-star starred"></i></span></td>
                                            ...
                                            <tr class="clickable-row">
                                                ...
                                                <td><span class="mail-important"><i
                                                            class="far fa-star starred"></i></span></td>
