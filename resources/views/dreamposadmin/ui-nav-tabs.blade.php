                            ...
                            <div class="row">
                                <div class="col-xl-3">
                                    <ul class="nav nav-tabs flex-column nav-style-4" role="tablist">
                                        <li class="nav-item">
                                            <a class="nav-link active" data-bs-toggle="tab" role="tab"
                                                aria-current="page" href="#home-vertical" aria-selected="true">Home</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" data-bs-toggle="tab" role="tab" aria-current="page"
                                    ...
                                    <div class="tab-content">
                                        ...
                                        <div class="tab-pane show active text-muted" id="services-vertical-link"
                                            ...
                                            the numbers. <b><i>Will mexican food ever rule the world? The 10 best thai
                                                    restaurant youtube videos</i></b>. How restaurant weeks can make you
                                            sick.
                                            The complete beginner's guide to cooking healthy food. Unbelievable
                                            food stamp success stories.
                                        </div>
                        ...
                        <div class="card-body px-sm-4 px-2">
                            ...
                            <div class="tab-content" id="myTabContent1">
                                ...
                                <div class="tab-pane fade text-muted" id="profile-tab-pane" role="tabpanel"
                                    ...
                                    publishing packages as their default model text, and a search for <b>'lorem ipsum'</b>
                                    will over the
                                    years.</div>
                                        ...
                                        <table class="table mb-0">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <th scope="row">
                                                        <span class="avatar avatar-sm">
                                                            <img src="{{ URL::asset('/build/img/products/product49.jpg')}}"
                                                                alt="img">
                                                        </span>
                                                    </th>
                                                    <td>Wrist Watch</td>
                                                ...
                                                <tr>
                                                    <th scope="row">
                                                        <span class="avatar avatar-sm">
                                                            <img src="{{ URL::asset('/build/img/products/product28.jpg')}}"
                                                                alt="img">
                                                        </span>
                                                    </th>
                                                    <td>Camera</td>
                                                ...
                                                <tr>
                                                    <th scope="row">
                                                        <span class="avatar avatar-sm">
                                                            <img src="{{ URL::asset('/build/img/products/product60.jpg')}}"
                                                                alt="img">
                                                        </span>
                                                    </th>
                                                    <td>Shoes</td>
                                            ...
                                            <div class="d-sm-flex">
                                                ...
                                                <div>
                                                    <div class="my-md-auto mt-4 ms-md-3">
                                                        ...
                                                        <p class="text-muted mb-0"><b>Lorem Ipsum</b> is simply dummy text
                                        ...
                                        <div class="tab-pane" id="man-password" role="tabpanel" tabindex="0">
                                            <ul class="list-unstyled text-muted mb-0">
                                                <li class="mb-2">Lorem Ipsum is simply dummy text of the printing and
                                                    typesetting industry. Lorem Ipsum has been the industry's <b>standard
                                                        dummy text ever since the 1500s</b>, when an unknown printer took a
                                                ...
                                                <li class="mb-2">Contrary to popular belief, Lorem Ipsum is not simply
                                                    ...
                                                    professor at Hampden-Sydney College in Virginia,</li>
                                                <li class="mb-0">There are many variations of passages of Lorem Ipsum
                                                    available, but the majority have suffered alteration in some form.</li>
                                            </ul>
                                        </div>
                                        ...
                                        <div class="tab-pane" id="main-email" role="tabpanel"
                                            ...
                                            <ul class="list-unstyled text-muted mb-0">
                                                ...
                                                <li class="mb-0">How hotel deals can help you live a better life. <b>How
                                                        celebrity cruises</b> aren't as bad as you think. How cultural
                                                    solutions can help you predict the future. How to cheat at dog friendly
                                                    hotels and get away with it. </li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="col-xl-6">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="tab-content">
                                <div class="tab-pane show active text-muted" id="hometab-dropdown" role="tabpanel">How
                                    travel coupons make you a better lover. Why cultural solutions are the new black. Why
                                    mom was right about travel insurances. How family trip ideas can helpyou predict the
                                    future. <b>How carnival cruises make you a better lover</b>. Why you'll never succeed at
                                    daily deals. 11 ways cheapest flights can find you the love of your life.</div>
                                <div class="tab-pane text-muted" id="homeabout-dropdown" role="tabpanel">
                                    How hotel deals can help you live a better life. <b>How celebrity cruises</b> aren't as
                                    bad as you think. How cultural solutions can help you predict the future. How to cheat
                                ...
                                <div class="tab-pane text-muted" id="homeproducts-dropdown" role="tabpanel">Lorem
                                    ...
                                    been the industry's <b>standard dummy text ever since the 1500s</b>, when an unknown
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <ul class="nav nav-pills mb-3" role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link active" data-bs-toggle="tab" role="tab"
                                        aria-current="page" href="#pill-products" aria-selected="true">Products</a>
                                </li>
                                <li class="nav-item dropdown">
                                    <a class="nav-link dropdown-toggle" data-bs-toggle="dropdown"
                            ...
                            <div class="tab-content">
                                <div class="tab-pane show active text-muted" id="pill-products" role="tabpanel">
                                    ...
                                    Why mom was right about travel insurances. How family trip ideas can helpyou predict the
                                    future. <b>How carnival cruises make you a better lover</b>. Why you'll never succeed at
                                    daily deals. 11 ways cheapest flights can find you the love of your life.
                                </div>
                                ...
                                <div class="tab-pane text-muted" id="pill-orders" role="tabpanel">Lorem Ipsum is
                                    ...
                                    industry's <b>standard dummy text ever since the 1500s</b>, when an unknown printer took
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <ul class="nav nav-pills nav-fill mb-3" role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link active" data-bs-toggle="tab" role="tab"
                                        aria-current="page" href="#fill-pill-home" aria-selected="true">Home</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" data-bs-toggle="tab" role="tab" aria-current="page"
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <ul class="nav nav-pills nav-justified mb-3 d-sm-flex d-block" role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link active" data-bs-toggle="tab" role="tab"
                                        aria-current="page" href="#justified-pill-home" aria-selected="true">Home</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" data-bs-toggle="tab" role="tab" aria-current="page"
                        ...
                        <div class="card-body">
                            <nav class="nav nav-pills flex-column flex-sm-row" role="tablist">
                                ...
                                <a class="flex-sm-fill text-sm-center nav-link" data-bs-toggle="tab" role="tab"
                                    aria-current="page" href="#pill-flex-big" aria-selected="false">More Data More The
                                    Tab Size</a>
                                <a class="flex-sm-fill text-sm-center nav-link" data-bs-toggle="tab" role="tab"
                            ...
                            <div class="tab-content mt-3">
                                <div class="tab-pane show active text-muted" id="pill-flex-home" role="tabpanel"> How
                                    travel coupons make you a better lover. Why cultural solutions are the new black. Why
                                    mom was right about travel insurances. How family trip ideas can helpyou predict the
                                    future. <b>How carnival cruises make you a better lover</b>. Why you'll never succeed at
                                    daily deals. 11 ways cheapest flights can find you the love of your life. The complete
                                    beginner's guide to mission trips. If you read one article about cultural notes read
                                    this one. Why you shouldn't eat vacation package in bed.</div>
                                <div class="tab-pane text-muted" id="pill-flex-big" role="tabpanel">How hotel deals
                                    can help you live a better life. <b>How celebrity cruises</b> aren't as bad as you
                                    think. How cultural solutions can help you predict the future. How to cheat at dog
                                    ...
                                    carnival cruises. How to start using cultural solutions.</div>
                                <div class="tab-pane text-muted" id="pill-flex-about" role="tabpanel"> Unbelievable
                                    healthy snack success stories. 12 facts about safe food handling tips that will impress
                                    your friends. Restaurant weeks by the numbers. Will mexican food ever rule the world?
                                    The 10 best thai restaurant youtube videos. How restaurant weeks can make you sick. The
                                    complete beginner's guide to cooking healthy food. Unbelievable food stamp success
                                    stories. How whole foods markets are making the world a better place. 16 things that
                                    won't happen in dish reviews.</div>
                            </div>
                        </div>
                    </div>
                </div>
