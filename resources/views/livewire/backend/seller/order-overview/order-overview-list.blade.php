                                ...
                                <div class="basic-form">
                                    <form >
                                        ...
                                        <div class="input-group mb-3 col-md-6">
                                            <select class="form-control default-select style-1 w-auto border">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-responsive-md">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td><strong>#{{ $order['order_nr'] }}</strong></td>
                                                <td>{{ Carbon\Carbon::parse($order['order_date'])->format('H:i') }}</td>
                                                <td>{{ $this->getStatusLabel($order['order_tracking_status'])['status'] }} <div class="d-flex align-items-center"><i class="fa fa-circle text-{{ $this->getStatusLabel($order['order_tracking_status'])['color'] }} me-1"></i> Successful</div></td>
                                                <td><span class="w-space-no">{{ $order['name'] }} {{ $order['surname'] }}</span></div></td>
                                                <td>{{ $order['shipping_street'] }}</td>
                                                <td>{{ $order['shipping_zip'] }} {{ $order['shipping_city'] }}</td>
