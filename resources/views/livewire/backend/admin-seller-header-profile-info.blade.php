        ...
        <li>
                ...
                <div class="dropdown-menu dropdown-menu-end">
                    <a href="{{ route('admin.profile') }}" class="dropdown-item ai-icon ">
                        ...
                        <span class="ms-2">@autotranslate('Edit Profile', app()->getLocale())</span>
                    </a>
                    <a href="./email-inbox.html" class="dropdown-item ai-icon">
                        ...
                        <span class="ms-2">@autotranslate('Inbox', app()->getLocale())</span>
                    </a>
                    ...
                    <a href="./message.html" class="dropdown-item ai-icon ">
                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="svg-main-icon">
                            ...
                            <span class="ms-2">@autotranslate('Message', app()->getLocale())</span>
                    </a>
                ...
                <a href="{{ route('admin.settings') }}" class="dropdown-item ai-icon ">
                    ...
                    <span class="ms-2">@autotranslate('Settings', app()->getLocale())</span>
                </a>
                    <a href="{{  route('admin.logout_handler') }}" class="dropdown-item ai-icon ms-1"
                        ...
                        <span class="ms-1">@autotranslate('Logout', app()->getLocale())</span>
                    </a>
            ...
            <div class="dropdown header-profile2 ">
                ...
                <div class="dropdown-menu dropdown-menu-end">
                    <a href="{{ route('seller.profile') }}" class="dropdown-item ai-icon ">
                        <svg  xmlns="http://www.w3.org/2000/svg" class="text-primary" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"></path><circle cx="12" cy="7" r="4"></circle></svg>
                        <span class="ms-2">@autotranslate('Profile', app()->getLocale())</span>
                    </a>
                    <a href="./email-inbox.html" class="dropdown-item ai-icon">
                        <svg  xmlns="http://www.w3.org/2000/svg" class="text-primary" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"></path><polyline points="22,6 12,13 2,6"></polyline></svg>
                        <span class="ms-2">@autotranslate('Inbox', app()->getLocale())</span>
                    ...
                    <span class="ms-2">@autotranslate('Notification', app()->getLocale()) </span>
                </a>
                <a href="{{ route('seller.settings') }}" class="dropdown-item ai-icon ">
                    ...
                    <span class="ms-2">@autotranslate('Logout', app()->getLocale()){{ app(\App\Services\TranslationService::class)->trans('Settings', app()->getLocale()) }} </span>
                </a>
    ...
    <ul class="navbar-nav header-right ">
        ...
        <li>
            <div class="dropdown header-profile2 ">
                <a class="nav-link " href="javascript:void(0);"  role="button" data-bs-toggle="dropdown">
                    <div class="header-info2 d-flex align-items-center">
                        <img src="{{ $broker->picture }}" alt="">
                        <div class="d-flex align-items-center sidebar-info">
                            <div>
                                <h6 class="font-w500 mb-0 ms-2">{{ $broker->username }}</h6>
                            </div>
                            <i class="fas fa-chevron-down"></i>
                        </div>
                    </div>
                ...
                <a href="{{  route('broker.logout_handler') }}" class="dropdown-item ai-icon ms-1"
                onclick="event.preventDefault(); document.getElementById('brokerLogoutForm').submit();">
                <svg  xmlns="http://www.w3.org/2000/svg" class="text-primary" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M9 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h4"></path><polyline points="16 17 21 12 16 7"></polyline><line x1="21" y1="12" x2="9" y2="12"></line></svg>
                <span class="ms-1">@autotranslate('Logout', app()->getLocale())</span>
            </a>
            <form id="brokerLogoutForm" action="{{ route('broker.logout_handler') }}" method="POST" class="d-none">
                @csrf
            </form>
                </div>
