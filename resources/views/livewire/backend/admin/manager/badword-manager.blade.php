    ...
    <div class="card">
        ...
        <div class="card-body">
                    ...
                    <tbody>
                        @foreach ($badwords as $index => $badword)
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex">
                                        <button wire:click="editBadword({{ $badword->id }})" class="btn btn-primary btn-xs shadow me-1"><i class="fa fa-pencil"></i></button>
                                        <button wire:click="deleteBadword({{ $badword->id }})" class="btn btn-danger btn-xs shadow"><i class="fa fa-trash"></i></button>
                                    </div>
                                </td>
                            </tr>
                        @endforeach
            ...
            <div class="mt-4">
                ...
                <button wire:click="addBadword" class="btn btn-success btn-sm mt-2">Hinzufügen</button>
            ...
            @if ($editId)
                <div class="mt-4">
                    ...
                    <button wire:click="updateBadword" class="btn btn-warning btn-sm mt-2">Aktualisieren</button>
