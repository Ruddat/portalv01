            ...
            <div class="col-xl-12">
                <div class="d-flex align-items-center justify-content-between mb-4">
                    <div class="input-group search-area2">
                        ...
                        <input type="text" class="form-control p-0" placeholder="Search Bills" wire:model.live="search" wire:keydown.enter="resetSearch">
                    </div>
                    <select wire:model.live="sortOption" class="form-control default-select border w-auto">
                ...
                <div class="card h-auto biil-bx">
                    <div class="card-header flex-wrap d-none d-sm-flex">
                        ...
                        <h4 class="font-w600 mb-0">Order</h4>
                    ...
                    <div class="card-body p-0  overflow-hidden">
                        <div id="accordion-one" class="accordion style-1">
                            ...
                            <div class="accordion-item">
                                <div class="accordion-header collapsed" data-bs-toggle="collapse" data-bs-target="#default_collapseOne{{ $order['id'] }}">
                                    <div class="d-flex align-items-center">
                                        <div class="form-check style-3 me-3">
                                            <input class="form-check-input" type="checkbox" value="">
                                        </div>
                                        <h5 class="font-w500 mb-0">Order #{{ $order['id'] }}</h5>
                                    </div>
                                    <p>Status: <span class="btn btn-outline-{{ $this->getStatusLabel($order['order_tracking_status'])['color'] }} bgl-{{ $this->getStatusLabel($order['order_tracking_status'])['color'] }} btn-sm">{{ $this->getStatusLabel($order['order_tracking_status'])['status'] }}</span></p>


                                    <p class="">{{ Carbon\Carbon::parse($order['order_date'])->format('F j, Y h:i A') }}</p>
                                    <div class="d-flex align-tems-center">
                                        ...
                                        <h5 class="mb-0">{{ $order['shipping_street'] }}, {{ $order['shipping_city'] }}</h5>
                                    </div>
                                    <h4 class="price">$ {{ $order['price_total'] }}</h4>
                                    <h5 class=" cash font-w500 ">{{ $order ['payment_type'] }}</h5>
                                    <span class="accordion-header-indicator style-1"></span>
                                </div>
                                <div id="default_collapseOne{{ $order['id'] }}" class="collapse accordion_body" data-bs-parent="#accordion-one">
                                    <div class="row">
                                        <div class="col-xl-3 col-xxl-6 col-sm-6 my-4 border-right">
                                            <div class="order-menu dlab-space">
                                                ...
                                                <div class="d-flex align-items-center justify-content-xl-center justify-content-lg-start  mb-2">
                                                    <img class="me-2" src="{{ asset('backend/images/popular-img/review-img/pic-1.jpg') }}" alt="">
                                                    <div>
                                                ...
                                                <div class="d-flex align-items-center justify-content-xl-center justify-content-lg-start">
                                                    <img class="me-2" src="{{ asset('backend/images/popular-img/pic-1.jpg') }}" alt="">
                                                    <div>
                                                        <h6 class="font-w600 text-nowrap mb-0 ">Pepperoni Pizza</h6>
                                                        <p class="mb-0">x1</p>
                                                    </div>
                                        ...
                                        <div class="col-xl-3 col-xxl-6 col-sm-6 my-4 border-right">
                                            <div class="dlab-space">
                                                <div>
                                                    <h4 class="mb-2">{{ $order['shop_name'] }}</h4>
                                        ...
                                        <div class="col-xl-3 col-xxl-6 col-sm-6 my-4 border-right">
                                            <div class="dlab-space">
                                                ...
                                                <div class="d-flex align-items-center justify-content-between mb-4">
                                                    <h6>{{ $this->getStatusLabel($order['order_tracking_status'])['status'] }}</h6>
                                                    <h6>{{ Carbon\Carbon::parse($order['order_date'])->format('F j, Y') }}</h6>
                                                </div>
                                                <div class="d-flex align-items-center justify-content-between mb-1">
