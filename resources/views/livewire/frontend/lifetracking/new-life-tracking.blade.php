...
<!-- /container -->
<div>
    <button onclick="simulateTracking()" class="btn btn-primary">Simulate Tracking</button>
...
<script>
    function simulateTracking() {
        Livewire.dispatch('simulateTracking');
    }
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        window.livewire.on('updatePosition', (position) => {
