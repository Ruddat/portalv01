						...
						<form id="registration_form" action="{{ route('seller.register_handler') }}" method="POST">
                            ...
                            <input type="hidden" name="bot_trap" value="">
								...
								<div class="row">
									<div class="col-lg-12">
										<div class="form-group">
											<input type="text" class="form-control" value="{{ old('name_register') }}" placeholder="Name and Last Name" name="name_register" id="name_register">
										</div>
                                        @error('name_register')
								...
								<div class="row add_bottom_15">
									<div class="col-lg-12">
										<div class="form-group">
											<input type="email" class="form-control" value="{{ old('email_register') }}" placeholder="Email Address" name="email_register" id="email_register">
										</div>
								...
								<div class="row">
									<div class="col-lg-12">
										<div class="form-group">
											<input type="text" class="form-control" value="{{ old('restaurantname_register') }}" placeholder="{{ app(\App\Services\TranslationService::class)->trans('Restaurant Name', app()->getLocale()) }}" name="restaurantname_register" id="restaurantname_register">
										</div>
								...
								<div class="row add_bottom_15">
									<div class="col-md-6">
										<div class="form-group">
											<input type="text" class="form-control" value="{{ old('city_register') }}" placeholder="City" name="city_register" id="city_register">
										</div>
                                        @error('name_register')
                                        <div class="d-block text-danger" style="margin-top: -15px; margin-bottom: 15px;">{{ $message }}</div>
                                        @enderror
                                        ...
                                        <div class="form-group">
                                            <div class="custom_select submit">
                                                <select name="country_register" id="country_register" class="form-control wide">
                                                    ...
                                                    <option value="Europe" @if(old('country_register') == 'Europe') selected @endif>Europe</option>
                                                    <option value="Asia" @if(old('country_register') == 'Asia') selected @endif>Asia</option>
                                                    <option value="Unated States" @if(old('country_register') == 'Unated States') selected @endif>Unated States</option>
                                                    <option value="Oceania" @if(old('country_register') == 'Oceania') selected @endif>Oceania</option>
                                                </select>
                                            </div>
								...
								<div class="form-group text-center">
                                    <input type="submit" class="btn_1 gradient" value="{{ app(\App\Services\TranslationService::class)->trans('Restaurant Anmelden', app()->getLocale()) }}">
                                </div>
