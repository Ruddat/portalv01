        ...
        <div class="content-body">
            <div class="container">
				<div class="row page-titles">
					<ol class="breadcrumb">
						<li class="breadcrumb-item active"><a href="{{ route('seller.dashboard') }}">Home</a></li>
                            ...
                            <div class="profile-head">
                                ...
                                <div class="profile-info">
                                    <div class="profile-photo">
                                        <a href="javascript:;" onclick="event.preventDefault();document.getElementById('sellerProfilePictureFile').click();" class="edit-avatar">
                                        ...
                                        <img src="{{ $seller->picture }}" class="img-fluid rounded-circle" alt="" id="sellerProfilePicture">
                                        <input type="file" name="sellerProfilePictureFile" id="sellerProfilePictureFile" class="d-none" style="opacity:0">
                                    </div>
									<div class="profile-details">
										<div class="profile-name px-3 pt-2">
											<h4 class="text-primary mb-0" id="sellerProfileName">{{ $seller->name }}</h4>
											<p></p>
										</div>
										<div class="profile-email px-2 pt-2">
											<h4 class="text-muted mb-0" id="sellerProfileEmail">{{ $seller->email }}</h4>
											<p>Email</p>
										</div>
                ...
                <div class="row">
                    ...
                    @livewire('backend.seller.settings.seller-profile-tabs')
