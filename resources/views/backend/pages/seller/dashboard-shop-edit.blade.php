            ...
            <div class="container">
				<div class="row page-titles">
					<ol class="breadcrumb">
						...
						<li class="breadcrumb-item"><a href="javascript:void(0)"><p>{{ session('currentShopTitle') }}</p></a></li>
					</ol>
                ...
                <div class="row">
                    ...
                    <div class="col-xl-3">
                        <div class="card text-white bg-dark">
                            <div class="card-header">
                                <h5 class="card-title text-white"><i class="bi bi-shop"></i>  Shopdaten</h5>
                            </div>
                            <div class="card-body mb-0">
                                <p class="card-text">{{ session('currentShopTitle') }} Some quick example text to build on the card title and make up the bulk of the card's content.</p><a href="{{ route('seller.restoData', ['shop' => $shop]) }}" class="btn bg-white text-success light btn-card">Go
                                    somewhere</a>
                            </div>
                    ...
                    <div class="col-xl-3">
                        <div class="card text-white bg-success">
                            <div class="card-header">
                                <h5 class="card-title text-white"><i class="bi bi-door-open"></i> Öffnungszeiten</h5>
                            </div>
                            <div class="card-body mb-0">
                    ...
                    <div class="col-xl-3">
                        <div class="card text-white bg-success">
                            <div class="card-header">
                                <h5 class="card-title text-white"><i class="bi bi-receipt"></i> Liefergebiet</h5>
                            </div>
                            <div class="card-body mb-0">
                                <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p><a href="{{ route('seller.deliveryarea', ['shop' => $shop]) }}" class="btn bg-white text-success light btn-card">Go
                                    somewhere</a>
                            </div>
                            <div class="card-footer bg-transparent border-0 text-white">Last updateed 3 min ago
                            </div>
                    ...
                    <div class="col-xl-6">
                        <div class="card">
                            ...
                            <img class="img-fluid" src="./images/card/3.png" alt="Card image cap">
                            <div class="card-footer">
                                <p class="card-text d-inline">Card footer</p>
                                <a href="javascript:void(0);" class="card-link float-end">Card link</a>
                            </div>
