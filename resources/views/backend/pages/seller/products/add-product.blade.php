                    ...
                    <div class="card-body">
                        <div class="basic-form">
                            <form action="{{ route('seller.manage-products.store-product') }}" method="POST" enctype="multipart/form-data" class="mt-3">
                                ...
                                <div class="row">
                                    <div class="mb-3 col-md-2">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="product_article_no" class="form-control input-default" value="{{ old('product_article_no') }}" placeholder="Article-No">
                                    ...
                                    <div class="mb-3 col-md-10">
                                        <div class="form-group">
                                            <label for="product-title" class="form-label">@autotranslate('Product title', app()->getLocale())</label>
                                            <input type="text" name="product_title" class="form-control input-default" value="{{ old('product_title') }}" placeholder="Enter product name">
                                            @error('product_title')
                                                <div class="alert alert-danger">
                                                    {{ app(\App\Services\AutoTranslationService::class)->trans($message, app()->getLocale()) }}
                                                    </div>
                                ...
                                <!-- MwSt-Auswahl-Feld -->
                                <div class="mb-3">
                                    <label for="tax-rate" class="form-label">@autotranslate('Tax Rate', app()->getLocale())</label>
                                    <select name="tax_rate" class="form-control">
                                        <option value="">@autotranslate('Select Tax Rate', app()->getLocale())</option>
