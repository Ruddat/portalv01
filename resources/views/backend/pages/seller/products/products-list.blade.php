                                    ...
                                    <tr>
                                        <td colspan="12">
                                            <div class="alert alert-dark solid alert-rounded">
                                                ...
                                                <strong>@autotranslate('Products!', app()->getLocale())</strong> {{ app(\App\Services\TranslationService::class)->trans('No product found - Erstelle hier neue Artikel/Produkte', app()->getLocale()) }}
                                            </div>
                                        </td>
                                    </tr>
                                    @endforelse
