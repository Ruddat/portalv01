                                    ...
                                    <div class="col-md-2">
                                        <div class="mb-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="product_basic_price" class="form-control input-default" value="{{ old('product_basic_price', $product->base_price ?? '') }}" placeholder="00.00">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select name="tax_rate" class="form-control">
                                        ...
                                        @foreach($taxRateOptions as $taxRate)
                                            <option value="{{ $taxRate['id'] }}" {{ $taxRate['id'] == $product->tax_rate_id ? 'selected' : '' }}>{{ $taxRate['name'] }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="form-group">
...
<script>
    ...
    if (typeof jQuery != 'undefined') {
        ...
        $(document).ready(function() {
            ...
            // Event-Handler für den "Remove"-Button
