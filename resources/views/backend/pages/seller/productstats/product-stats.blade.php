        ...
        <div class="content-body">
            ...
            <div class="container">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="media-bx d-flex py-3  align-items-center">
                                                            <img class="me-3 rounded-circle" src="images/popular-img/pic-1.jpg" alt="images">
                                                            <div>
                                                    ...
                                                    <td><span class="badge badge-xl light badge-success">Aktiv</span></td>
                                                    <td>
                                                        <div>
                                                            <a href="javascript:void(0);" class="btn btn-outline-primary">Angebot</a>
                                                        </div>
                                                    </td>
                                                </tr>
                                    ...
                                    <div class="card dishe-bx b-hover style-1">
                                        ...
                                        <div class="card-body pb-0 pt-3">
                                            ...
                                            <div class="border-bottom pb-3">
                                                <h4 class="font-w500 mb-1">Fast Food Resto</h4>
                                        ...
                                        <div class="card-footer border-0 pt-2">
                                            <div class="common d-flex align-items-center justify-content-between" >
                                                <div>
                                                    ...
                                                    <h3 class=" mb-0 text-primary">$5.59</h3>
                                                </div>
                                ...
                                <div class="col-xl-3 col-xxl-4 col-sm-6">
                                    <div class="card review b-hover style-1">
                                        ...
                                        <div class="card-body pb-0 pt-3">
                                            ...
                                            <div class="border-bottom pb-3">
                                                <h4 class="mb-1 font-w500">Fast Food Resto</h4>
                                                <div class="d-flex align-items-center">
                                                    <svg width="16" height="15" viewBox="0 0 16 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M8 0.500031L9.79611 6.02789H15.6085L10.9062 9.4443L12.7023 14.9722L8 11.5558L3.29772 14.9722L5.09383 9.4443L0.391548 6.02789H6.20389L8 0.500031Z" fill="#FC8019"/>
                                                    </svg>
               ...
               <div class="row">
                    ...
                    <livewire:backend.seller.product-stats.renner-penner-list :shopId="$shopId" />
