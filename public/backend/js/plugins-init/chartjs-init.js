 ...
 var dzSparkLine = function(){
	...
	var barChart2 = function(){
		...
		//gradient bar chart
			...
			barChart_2gradientStroke.addColorStop(0, "rgba(252, 128, 25, 1)");
	...
	var barChart3 = function(){
		...
		if(jQuery('#barChart_3').length > 0 ){
			...
			barChart_3gradientStroke.addColorStop(0, "rgba(252, 128, 25, 1)");
					...
					datasets: [
						{
							...
							pointBackgroundColor: 'rgba(252, 128, 25, 1)',
							tension: 0.5,
						}
					]
				},
	...
	var lineChart3 = function(){
		...
		if(jQuery('#lineChart_3').length > 0 ){
			...
			lineChart_3gradientStroke1.addColorStop(0, "rgba(252, 128, 25, 1)");
