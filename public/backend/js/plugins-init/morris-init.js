	...
	var dlabMorris = function(){
		...
		var donutChart = function(){
			Morris.Donut({
				...
				resize: true,
				redraw: true,
				colors: ['#fc8019', 'rgb(255, 92, 0)', '#9D1CB2'],
				//responsive:true,
		...
		var lineChart2 = function(){
			...
			Morris.Area({
				...
				pointSize: 3,
				fillOpacity: 0,
				pointStrokeColors: ['#EE3C3C', '#9D1CB2', '#fc8019'],
				behaveLikeLine: true,
				gridLineColor: 'transparent',
				lineWidth: 3,
				hideHover: 'auto',
				lineColors: ['rgb(238, 60, 60)', 'rgb(0, 171, 197)', '#fc8019'],
				resize: true
		...
		var barChart = function(){
			...
			//bar chart
				Morris.Bar({
					...
					ykeys: ['a', 'b', 'c'],
					labels: ['A', 'B', 'C'],
					barColors: ['#fc8019', '#9D1CB2', '#ff9f00'],
					hideHover: 'auto',
					gridLineColor: 'transparent',
					resize: true,
					barSizeRatio: 0.25,
		...
		var areaChart = function(){
			...
			Morris.Area({
				...
				lineColors: ['#fc8019', 'rgb(16, 202, 147)', 'rgb(255, 92, 0)'],
				xkey: 'period',
				ykeys: ['smartphone', 'windows', 'mac'],
				labels: ['Phone', 'Windows', 'Mac'],
				pointSize: 0,
