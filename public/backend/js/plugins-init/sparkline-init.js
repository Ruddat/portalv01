	...
	var sparkLine8 = function(){
		if(jQuery('#sparkline8').length > 0 ){	
			$("#sparkline8").sparkline([79, 72, 29, 6, 52, 32, 73, 40, 14, 75, 77, 39, 9, 15, 10], {
				...
				height: "50",
				lineColor: "#fc8019",
				fillColor: "rgba(252, 128, 25, 1)",
				minSpotColor: "#fc8019",
				maxSpotColor: "#fc8019",
				highlightLineColor: "#fc8019",
				highlightSpotColor: "#fc8019",
		...
		if(jQuery('#StackedBarChart').length > 0 ){	
			$('#StackedBarChart').sparkline([
				...
				[4, 1, 2]
					...
					barWidth: 10,
					barSpacing: 7, 
					stackedBarColor: ['#fc8019', '#9D1CB2', '#ff5c00']
				});
		}
	}
	...
	var sparkLine11 = function(){
		if(jQuery('#sparkline11').length > 0 ){
			...
			$("#sparkline11").sparkline([24, 61, 51], {
				...
				height: "100px",
				resize: !0,
				sliceColors: ["rgba(192, 10, 39, .5)", "rgba(0, 0, 128, .5)", "rgba(252, 128, 25, 1)"]
			});
		}	
	}	
	...
	var sparkLine12 = function(){
		if(jQuery('#sparkline12').length > 0 ){
			...
			$("#sparkline12").sparkline([24, 61, 51], {
				...
				height: "100",
				resize: !0,
				sliceColors: ["rgba(255,255,255, 0.4)", "rgba(255,255,255, 0.5)", "rgba(255,255,255, 0.7)"]
			});
		}	
	}	
