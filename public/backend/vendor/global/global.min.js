...
function dlabSettings({typography, version, layout, navheaderBg, headerBg, sidebarStyle, sidebarBg, sidebarPosition, headerPosition, containerLayout, direction, primary, secondary}) {
...
dlabSettings.prototype.manageSidebarStyle = function() {
    ...
    switch(this.sidebarStyle) {
        ...
        case "icon-hover":
			...
			$("body").on("mouseenter", ".dlabnav", function(){
				$('#main-wrapper').addClass('iconhover-toggle');
			}).on("mouseleave", ".dlabnav", function(){
				$('#main-wrapper').removeClass('iconhover-toggle');
			});
			
			/* $('.dlabnav').on("mouseenter",function() {
                $('#main-wrapper').addClass('iconhover-toggle');
            }, function() {
                $('#main-wrapper').removeClass('iconhover-toggle');
            });  */
...
dlabSettings.prototype.manageSecondaryColor = function() {
